        ...
        <PrivateRoute roleList={["LIDER", "ADMINISTRADOR"]}>
            <div className="bg-white mt-3 relative mx-auto rounded-lg container">
                ...
                <input
                    ...
                    value={busqueda}
                    className="input-s"
                    placeholder="Busca un usuario por correo o ID"
                    type="text" />
            </div>
            <TableMobile
            dataFiltrada={secondFilter}
            />
            <TableDesktop
            dataFiltrada={secondFilter}
            />
...
const TableDesktop = ({ dataFiltrada }) => {
...
const TableMobile = ({ dataFiltrada }) => {
